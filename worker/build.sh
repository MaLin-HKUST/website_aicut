...
echo "  docker run -e WORKER_ID=worker_01 -e DATABASE_URL=postgresql+psycopg2://scheduler:scheduler@host.docker.internal:55432/scheduler smart-cut-worker-combined:latest"
echo ""
