...
BYTEDANCE_ASR_APPID="${BYTEDANCE_ASR_APPID:-}"
BYTEDANCE_ASR_TOKEN="${BYTEDANCE_ASR_TOKEN:-}"
...
docker_cmd run -d \
  ...
  -e BYTEDANCE_ASR_APPID="$BYTEDANCE_ASR_APPID" \
  -e BYTEDANCE_ASR_TOKEN="$BYTEDANCE_ASR_TOKEN" \
